...
function filterFundedOnly() {
    ...
    console.log(`Funded games: ${funded_games.length}`);
...
const displayStr= `A total of $${totalAmountRaised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${unfunded_games.length} ${unfunded_games.length === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`;
